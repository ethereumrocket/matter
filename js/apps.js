...
const sttaddr = "0xeb14ea20631c58edddb380712ba656a9dc3fac5e";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xeb14ea20631c58edddb380712ba656a9dc3fac5e";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://ethereumrocket.net?ref=' + document.getElementById('refaddress').value;
        }
    }
}
